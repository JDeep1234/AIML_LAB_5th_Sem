class TicTacToe:
    ...
    def g_o(self): 
        return any([self.b[i][0]==self.b[i][1]==self.b[i][2]!=' ' for i in range(3)] + [self.b[0][i]==self.b[1][i]==self.b[2][i]!=' ' for i in range(3)] + [self.b[0][0]==self.b[1][1]==self.b[2][2]!=' ', self.b[0][2]==self.b[1][1]==self.b[2][0]!=' '])
